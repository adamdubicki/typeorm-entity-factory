...
This will inject the database connection into all of factories and allow us to use nested factories as described later. The connection must be to the database which has the entity generated by the factories parameter.
...
Using what we our previous factories -we can declare the last factory.
